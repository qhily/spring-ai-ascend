...
EXCLUDE_DIRS = ('./docs/archive/', './docs/logs/', './docs/adr/',
                ...
                './knowledge/', './docs/architecture/', './architecture/docs/L1/', './docs/reviews/')
...
#   2. docs/harness/debug-first-evidence.md contains the literal string
...
# ---------------------------------------------------------------------------
_r79_fail=0
_r79_runbook="docs/harness/debug-first-evidence.md"
...
if [[ -f "$_r79_card" ]] && ! grep -qF 'docs/harness/debug-first-evidence.md' "$_r79_card" 2>/dev/null; then
  fail_rule "rule_79_runbook_present_and_cited" "$_r79_card does not reference docs/harness/debug-first-evidence.md — Rule 79 / E112 (card-runbook link broken)"
  _r79_fail=1
fi
