...
Authority documents: `docs/reviews/2026-05-18-l0-rc7-post-corrective-architecture-review.en.md` (review) and `docs/reviews/2026-05-18-l0-rc7-post-corrective-architecture-review-response.en.md` (response).
