...
- **Asynchronous Decoupling via Queues**: An internal high-throughput event/task queue decouples network I/O from heavy CPU/LLM processing threads.
- **Stateless and Semi-persistence Policies**:
