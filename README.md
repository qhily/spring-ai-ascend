...
> Enterprise agent platform on Spring AI 2.0.0-M5 + Spring Boot 4.0.5 + Java 21 — as of v2.0.0-rc11 (2026-05-19 rc10 post-corrective architecture review response + Rule 94 widening + v2.0.0-rc10 (retracted); ADR-0085).
