...
- Architecture baseline: **65 §4 constraints · 94 ADRs · 123 active gate rules · 210 gate self-tests** · 13 Layer-0 governing principles · 157 enforcer rows · 37 active engineering rules (D-/R-/G-/M- namespace per [ADR-0086](docs/adr/0086-rule-namespace-ratchet.yaml); rc14 adds Rule G-8; rc15 widens G-8.e+G-8.d+G-3.e; rc16 adds 4 gate-layer rules per ADR-0093; rc17 splits R-C→R-C+R-C.1+R-C.2, R-I→R-I+R-I.1, G-3→G-3+G-3.1, G-2→G-2+G-2.1 and adds Rule G-9 per ADR-0094 = +6 engineering rules; rc18 is pure hardening — no new rules per ADR-0095) · 9 recurring defect families catalogued (rc18 adds F-recursive-prevention-irony per ADR-0095) · 374 Maven tests green · architecture-graph nodes / edges regenerated post-merge (395 / 642 at rc18 Wave 5: Wave 4 phantom-node cleanup net -13/-9, Wave 5 +1/+8 from ADR-0095 + new family). Canonical structured baseline lives in [`docs/governance/architecture-status.yaml#architecture_sync_gate.baseline_metrics`](docs/governance/architecture-status.yaml) (single source of truth). Wave history lives at [`docs/logs/governance-waves.md`](docs/logs/governance-waves.md). Gate enforcement: Rule G-2.b + Rule G-2.d + Rule G-2.1.a + Rule G-5.a + Rule G-5.b + Rule G-5.c + Rule 101 + Rule 105 + Rule 106 + Rule 107 + Rule 108 + Rule 109 + Rule 110 META + Rule 111 (rc17, hardened in rc18 Wave 1 per ADR-0095) + Rule 44 (rc18 Wave 2 shallow-clone safeguard).
