...
**65 §4 constraints · 139 ADRs · 159 active gate rules · 306 gate self-tests**,
plus 13 Layer-0 governing principles, 57 active engineering rules, and 194 enforcer rows, with a 692-node / 1355-edge architecture graph — all maintained in
