 ...
 *
 * <p>This is the semantic home for {@link ascend.springai.engine.runtime.EngineRegistry}
 * (single dispatch authority per Rule R-M sub-clause .a) and
 * {@link ascend.springai.engine.runtime.EngineEnvelope} (engine request shape
 * mirroring {@code docs/contracts/engine-envelope.v1.yaml}). The package is NOT
 * the engine SPI surface — that is {@code ascend.springai.engine.spi.*}; the SPI
 ...
 * {@code ascend.springai.service.runtime.engine.*} for backwards source
 * compatibility through the engine-extraction wave; rc14 (ADR-0090,
 * 2026-05-20) relocated them to {@code ascend.springai.engine.runtime.*}
