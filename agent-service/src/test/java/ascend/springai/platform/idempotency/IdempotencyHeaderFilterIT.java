...
class IdempotencyHeaderFilterIT {
    ...
    @Test
    void healthEndpoint_exemptFromIdempotencyFilter_withoutHeader() throws Exception {
    ...
    @Test
    void healthEndpoint_exemptFromIdempotencyFilter_withHeader() throws Exception {
        HttpResponse<String> response = HTTP.send(
